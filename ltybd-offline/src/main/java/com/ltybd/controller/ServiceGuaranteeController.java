...
/**
 * ServiceGuaranteeController.java
 *
 * describe:
 * 
 * 2017年10月17日 上午11:36:32 created By chenq version 0.1
 *
 * 2017年10月17日 上午11:36:32 modifyed By chenq version 0.1
 *
 * copyright 2002-2017 深圳市蓝泰源电子科技有限公司
 */
@Api(value = "/serviceGuarantee", description = "服务保障能查询")
@RestController
...
public class ServiceGuaranteeController {
	 ...
	 * 
	 */
	@ApiOperation(value = "服务保障能查询接口  code:002004001", produces = "application/json")
	@RequestMapping(value = "ServiceSupportCapability", method = { RequestMethod.POST, RequestMethod.GET })
	@ApiImplicitParams({
	...
	@ResponseBody
	public  Map<String,Object> ServiceSupportCapability(String apikey,Integer line_id,Integer company_id,String city_code,String direction,String date_end,Integer date_period,Integer step){
		...
		graphData.addAll(serviceGuaranteeService.passengerFlowDetail(param));
		//服务保障能力车辆详情
		List<Map<String,Object>> pivotData=new ArrayList<Map<String,Object>>();
		...
		response.put("graph_data", graphData);
		response.put("pivot_data", pivotData);
