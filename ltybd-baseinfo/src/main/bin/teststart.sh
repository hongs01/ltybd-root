...
#>>>>>>>>>>>>>>>>>>>>>>> modification begin
# bootstrap class
MAIN_CLASS=com.ltybd.BaseInfoApplication
...
# classpath
CLASSPATH="${PACKAGE_HOME}/classes:${PACKAGE_HOME}/lib/*:${PACKAGE_HOME}/conf"

# JVM startup parameters
JAVA_OPTS="-Dspring.profiles.active=test -server -Xmx2g -Xms2g -Xmn256m -XX:PermSize=128m -Xss256k -XX:+DisableExplicitGC -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:+UseCMSCompactAtFullCollection -XX:LargePageSizeInBytes=128m -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70"
